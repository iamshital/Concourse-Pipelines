...
Write-Host $PWD
Write-Host ----------------------
echo ".\AzureAutomationManager.ps1 -runtests -Distro CentOS71 -cycleName LIS-BUILD -xmlConfigFile Azure_ICA_all_run-CloudTestAutoBuilds-3427.xml -OverrideVMSize Standard_A1 -ImageType Standard -UseAzureResourceManager"
Write-Host ----------------------
